...
//  Discussion:
//
//    FEKETE_PRB calls the FEKETE test routines.
//
//  Licensing:
//
...
//
  ...
  {
    cout << "  " << setw(8)  << node+1
         << "  " << setw(22) << setprecision(18) << node_xy[0+node*2]
         << "  " << setw(22) << setprecision(18) << node_xy[1+node*2] << "\n";
  }
  ...
  {
    cout << "  " << setw(8)  << order
         << "  " << setw(22) << setprecision(18) << xy[0+order*2]
         << "  " << setw(22) << setprecision(18) << xy[1+order*2]
         << "  " << setw(22) << setprecision(18) << w[order] << "\n";
  }
//
//  Transform the rule.
//
