...
int main()
{
  ...
  typedef viennagrid::result_of::ncell_type<TriangleConfig, 2>::type              CellType;
  ...
  try
  {
    ...
    my_sgf_reader(my_domain, "../examples/data/sshape2d.sgf");
  }
  catch (...)
  {
      ...
      ++vit)
  {
    ...
    if (vit->getPoint().get_y() == 3.0 || vit->getPoint().get_x() == 5.0 )
