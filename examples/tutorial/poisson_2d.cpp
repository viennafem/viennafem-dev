...
int main()
{
  ...
  //
  viennafem::io::write_solution_to_VTK_file(pde_result_1, "poisson_2d_1", my_domain, 0);
  viennafem::io::write_solution_to_VTK_file(pde_result_2, "poisson_2d_2", my_domain, 1);
